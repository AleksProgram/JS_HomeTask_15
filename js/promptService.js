...
export function createBasePromptByRole(user) {
  if (user.role === ROLES.ADMIN) {
    return `
        ...
        Правила:
            ...
            и каждый продукт начинается с большой буквы. Укажи сколько
            штук или кг или литров нужно докупить, чтобы приготовить
            данное блюдо
  ...
  if (user.role === ROLES.USER) {
    return `
        ...
        Правила:
            ...
            из числа имеющихся и неимеющихся в холодильнике. и каждый продукт
            начинается с большой буквы. Напротив каждого продукта в скобках напиши
            в скобках: имеется, не имеется, в зависимости от наличия или
            отсутствия их в холодильнике
            -не возвращай продукты, не имеющие отношения к данному блюду.
  ...
  if (user.role === ROLES.GUEST) {
    return `
        ...
        Тебе дается название желаемого и список
        продуктов, имеющихся в холодильнике. 
        Твоя задача - выводить продукты, которые имеются в холодильнике
        и есть ли возможность приготовить такое блюдо или нет.
        Правила:
            -возвращай только список продуктов, которые нужно использовать
            из числа имеющихся в холодильнике и каждый продукт начинается
            с большой буквы.
            -не возвращай продукты, не имеющие отношения к данному блюду.
            -не возвращай продукты, которых нет в холодильнике.          
        `;
